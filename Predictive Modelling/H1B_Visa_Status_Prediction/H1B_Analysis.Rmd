...
cat("\n False Negative Rate: \n")
cat(round(t.full[2,1]*100/sum(t.full[2,]),2),"%") # 65.169% False Negatives/Classified Positives


```

Our logistic model captures most of the certified cases, which is expected. As far as denied cases go, we are capturing about `r 182*100/(182 + 427)`% of the actual denied cases which is not very good!
...
From the above plot, we can choose threshold = 0.08.  
